# hmpps-breach-report-co-sso-api

[![Ministry of Justice Repository Compliance Badge](https://github-community.service.justice.gov.uk/repository-standards/api/hmpps-breach-report-co-sso-api/badge?style=flat)](https://github-community.service.justice.gov.uk/repository-standards/hmpps-breach-report-co-sso-api)
[![Docker Repository on ghcr](https://img.shields.io/badge/ghcr.io-repository-2496ED.svg?logo=docker)](https://ghcr.io/ministryofjustice/hmpps-breach-report-co-sso-api)
[![API docs](https://img.shields.io/badge/API_docs_-view-85EA2D.svg?logo=swagger)](https://breach-report-co-sso-api-dev.hmpps.service.justice.gov.uk/swagger-ui/index.html)
...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-breach-report-co-sso-api/security/policy).
...
## Renaming from HMPPS Breach Report Co Sso Api - github Actions
...
```bash
docker compose pull && docker compose up --scale hmpps-breach-report-co-sso-api=0
```
