...
import uk.gov.justice.digital.hmpps.breachreportcossoapi.model.Identifiers
import uk.gov.justice.digital.hmpps.breachreportcossoapi.model.PersonReference
...
class SnsService(
  ...
  fun sendDeleteDomainEvent(crn: String, id: UUID) {
    ...
    val messageObject = DomainEventsMessage(
      ...
      version = 1,
      occurredAt = ZonedDateTime.now(ZoneId.of("Europe/London")),
      eventType = "probation-case.breach-report-co-sso.deleted",
        ...
        .messageAttributes(
          mapOf(
            "eventType" to MessageAttributeValue.builder().dataType("String")
              .stringValue("probation-case.breach-report-co-sso.deleted").build(),
          ),
        ).build(),
    )
